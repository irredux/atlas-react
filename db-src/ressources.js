        ...
        <Offcanvas.Body>
            ...
            {this.state.ressource===0||this.state.ressource===1||this.state.ressource===5?[
                ...
                <Row key="3" className="mb-2">
                    ...
                    <Col><input type="text" style={{width: "100%"}} value={this.state.volumeContent?this.state.volumeContent:""} onChange={e=>{this.setState({volumeContent: e.target.value})}} /></Col>
                </Row>,
            ...
            <Row className="mb-2">
                <Col><StatusButton value="speichern" onClick={async ()=>{
            if((this.state.ressource===0||this.state.ressource===1||this.state.ressource===5)&&(!this.state.editor||!this.state.year)){

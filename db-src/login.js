...
function LoginScreen(props){
    ...
    return <Container className="d-flex justify-content-center">
        <Form className="loginForm">
            ...
            <Row className="mt-3">
                <Col><small>Noch kein Konto? Klicken Sie <a onClick={()=>{props.setMode("create")}}>hier</a>.</small></Col>
...
function AccountCreate(props){
    ...
    return <Container className="d-flex justify-content-center">
        <Form className="loginForm">
            ...
            <Row><Col sm={4}></Col><Col sm={4}><StatusButton value="registrieren" onClick={async ()=>{
...
}}/></Col><Col><Button variant="secondary" onClick={()=>{props.setMode("login")}}>zurück</Button></Col></Row>
        </Form>
    </Container>;
}
/*

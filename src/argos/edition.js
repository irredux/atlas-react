    ...
    return <Navbar fixed="bottom" bg="light">
        <Container fluid>
            ...
            <Navbar.Collapse className="justify-content-end">
                <Navbar.Text>
                    {props.mode===0&&<Form.Range style={{position: "relative", top: "7px", marginRight: "10px", width:"400px"}} min="45" max="125" value={props.zoom} onChange={e=>{props.setZoom(parseInt(e.target.value))}} className="slider" />}

...
class AutoComplete extends React.Component{
    ...
    render(){
        ...
        return <div>
            <input className={this.props.classList} type="text" value={this.props.value} onBlur={()=>{setTimeout(()=>{this.setState({userSelected: true})},300)}} onChange={e=>{this.changeInputValue(e.target.value)}} onKeyDown={e=>{this.changeSelectedOption(e)}} />

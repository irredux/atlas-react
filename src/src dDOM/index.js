...
import { Opera, Konkordanz } from "./opera.js";
import { Import, Server, Statistics, Account } from "./settings.js";
...
class App extends React.Component {
    constructor(props){
        ...
        this.tbls = ["lemma", "work", "zettel", "user", "konkordanz", "opera"];
    }
    loadMain(res){
        if(res==="logout"){
            arachne.close();
        ...
        if(this.state.mode==="main"){
            ...
            switch(this.state.res){
                ...
                case "account":
                    ...
                    break;
                case "quellen":
                    main = <Opera status={(type,value)=>{this.newStatus(type, value)}} />;
                    break;
                case "konkordanz":
                    main = <Konkordanz status={(type,value)=>{this.newStatus(type, value)}} />;
                    break;
                case "stats":
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <h1 style={{textAlign: "center", gridArea: "2/2/2/4"}}>dDOM</h1>
